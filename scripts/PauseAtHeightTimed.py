...
class PauseAtHeightTimed(Script):
    def __init__(self):
        super().__init__()

    def getSettingDataString(self):
        return """{
            "name":"Pause at height (timed)",
            "key": "PauseAtHeightTimed",
            "metadata": {},
            "version": 2,
            "settings":
            {
				...
				"pause_duration": 
				{
					...
					"description": "How long the pause will be",
					"unit": "s",
					"type": "float",
					"default_value": 60
				},
                ...
                if self.getValue(line, 'G') == 1 or self.getValue(line, 'G') == 0:
                    ...
                    if current_z is not None:
                        ...
                        if current_height >= pause_height:
                            ...
                            prepend_gcode += "G4 P%i;Do the actual pause\n" % (pause_duration * 1000)
